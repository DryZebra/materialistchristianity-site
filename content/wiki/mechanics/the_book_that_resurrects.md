...
**John 5:39** ("In them ye think ye have eternal life"). Christ identifies that the scriptures are not the life themselves, but the **Evidence** (testimony) that points to the living motion (Him). The Book is the technical map; the "Resurrection" is the actual walking of the path and the physical result of that walk.

## Related Content
- [[canon_as_pressure]] — The weight of the archive.
- [[historical_alignment]] — Staying in sync with the map.
- [[resurrection_structural]] — The physical result of the protocol.
