...
description: "Meaning, trust, and neighborliness only become real when they are physically done with our hands."
category: "Foundational Essay"
tags: ["sacrament", "matter", "work", "community"]
---
...
Globalist "Social Gospels" and "Liberalism" try to replace the physical work of the faith with **Idealism**—the belief in an "idea" without any physical results. This is "Zero-Strength" faith. It has no mass and cannot help a town survive the collapses of history. Sacramental Materialism insists that if a truth is not "Flesh" (consequential), then it is **Nothing**.
...
> [!IMPORTANT]
> The "Word" did not become a "Message"; it became **Flesh**. To be "Real" is to be physical. To build the Kingdom is to build what **can be touched**.
