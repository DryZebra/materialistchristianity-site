...
Truth is the "track" that a motion leaves in the world. By measuring the consequences of a behavior, we can reverse-engineer the true structure of the belief behind it.

## Internal Logic
- **Connections**: 
  - [Reality as Motion](/wiki/node/reality_as_motion) - Truth is the record of motion.
  - [Forensic Analysis](/wiki/node/forensic_analysis_survival) - The method used to measure truth.
