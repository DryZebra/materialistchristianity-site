...
A forensic analysis of a church would not focus on its mission statement, but on its budget, its architecture, and the specific behavior it compels in its congregants on a Tuesday morning. This approach treats ideology as a "symptom" and behavior as the "evidence."

## Internal Logic
- **Connections**: 
  - [Consequence as Truth](/wiki/node/consequence_as_truth) - Analysis is the search for truth in consequences.
  - [Materialist Christianity](/wiki/node/materialism_behavioral_science) - The paradigm built upon this method.
