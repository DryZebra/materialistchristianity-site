...
## IV. CONNECTIONS
*   **Complemented By**: [4d_time_snake](/wiki/nodes/motion_as_reality), [the_entropic_dance](/wiki/nodes/rupture).
*   **Mechanism**: [Sub Object Resonance](/wiki/nodes/sub_object_resonance), [Social Reinvestment Loop](/wiki/nodes/social_reinvestment_loop).
*   **Counter-Diagnostic**: [The Hardness Of Heart](/wiki/nodes/the_hardness_of_heart) (the fossilization of the fractional self against communal motion).
