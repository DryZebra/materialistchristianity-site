...
2.  **Survival across the Vacuum**: Faith is the only mechanism that can carry survival-motion through [the_vacuum](/wiki/wiki/nodes/the_vacuum) (the space between collapse and re-entry). It is "blind" labor that holds the line when no consequence is visible.
3.  **Reactivation**: Faith is the fuel for [resurrection_structural](/wiki/wiki/nodes/resurrection_structural). When the pressure returns, this residue provides the initial "spark" of coordinated motion because the subjects still remember how to move together.
...
## IV. CONNECTIONS
*   **Source**: [moral_capital](/wiki/wiki/nodes/moral_capital).
*   **Path**: [the_vacuum](/wiki/wiki/nodes/the_vacuum).
*   **End Goal**: [resurrection_structural](/wiki/wiki/nodes/resurrection_structural).
