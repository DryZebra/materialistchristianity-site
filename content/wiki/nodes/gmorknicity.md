...
**Gmorknicity** is the forensic diagnostic for **Parasitic Hijacking.** It is the state where a [[the_sub_object]] or [[sub_object_resonance]] has been captured by an extractive force (Capital) to siphon labor-motion without contributing to survival. It is "Ritual without Consequence."
...
## IV. CONNECTIONS
*   **Target**: [[the_sub_object]].
*   **Result**: [[the_vacuum]], [[rupture]].
*   **Opposition**: [[moral_labor]], [[resurrection_structural]].
